...
namespace {
    ...
    uint32_t dbg_rx_frames = 0;
    uint32_t dbg_tx_frames = 0;
    uint32_t dbg_seq_resets = 0;
    uint32_t dbg_decode_ok = 0;
    uint32_t dbg_decode_ng = 0;

    void printDebugLogPeriodically() {
        ...
        Serial.printf(
            "[CAN_CLIENT][ID=%u] rx=%lu tx=%lu decode_ok=%lu decode_ng=%lu seq_reset=%lu\n",
            static_cast<unsigned>(DEVICE_ID),
            static_cast<unsigned long>(dbg_rx_frames),
            static_cast<unsigned long>(dbg_tx_frames),
            static_cast<unsigned long>(dbg_decode_ok),
            static_cast<unsigned long>(dbg_decode_ng),
            static_cast<unsigned long>(dbg_seq_resets));
...
void canNodeInit() {
    ...
    resetAssembly();
    Serial.printf("[CAN_CLIENT][ID=%u] init done (CAN %u kbps)\n", static_cast<unsigned>(DEVICE_ID), 1000U);
}
